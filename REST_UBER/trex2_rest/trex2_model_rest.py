...
import time
import trex2_functions_rest as trex2_mod
...
class trex2(object):
    ...
    def run_methods(self):
        ...
        # time series estimate based on first application rate - needs to be matrices for batch runs
        self.C_ts_sg = trex2_mod.conc_food_timeseries(self.day_out, self.rate_out, self.a_i, self.h_l, 240)  # short grass
        self.C_ts_tg = trex2_mod.conc_food_timeseries(self.day_out, self.rate_out, self.a_i, self.h_l, 110)  # tall grass
        self.C_ts_blp = trex2_mod.conc_food_timeseries(self.day_out, self.rate_out, self.a_i, self.h_l, 135)  # broad-leafed plants
        self.C_ts_fp = trex2_mod.conc_food_timeseries(self.day_out, self.rate_out, self.a_i, self.h_l, 15)  # fruits/pods
        self.C_ts_arthro = trex2_mod.conc_food_timeseries(self.day_out, self.rate_out, self.a_i, self.h_l, 94)  # arthropods

        # Table5
        logging.info("table 5")
        self.sa_bird_1_s = trex2_mod.sa_bird_1(0.1, 0.02, self.aw_bird_sm, self.tw_bird_ld50)
        self.sa_bird_2_s = trex2_mod.sa_bird_2(self.a_i, self.den, self.m_s_r_p, self.at_bird,
                                          self.ld50_bird, self.aw_bird_sm, self.tw_bird_ld50, self.x, 0.02)
        self.sc_bird_s = trex2_mod.sc_bird(self.a_i, self.den, self.NOAEC_bird)
        self.sa_mamm_1_s = trex2_mod.sa_mamm_1(self.a_i, self.den, self.at_mamm, self.fi_mamm, 0.1,
                                          self.ld50_mamm, self.aw_mamm_sm, self.tw_mamm, 0.015)
        self.sa_mamm_2_s = trex2_mod.sa_mamm_2(self.a_i, self.den, self.m_s_r_p, self.at_mamm,
                                          self.ld50_mamm, self.aw_mamm_sm, self.tw_mamm, 0.015)
        self.sc_mamm_s = trex2_mod.sc_mamm(self.a_i, self.den, self.NOAEL_mamm, self.aw_mamm_sm,
                                      self.fi_mamm, 0.1, self.tw_mamm, self.ANOAEL_mamm, 0.015)

        self.sa_bird_1_m = trex2_mod.sa_bird_1(0.1, 0.1, self.aw_bird_md, self.tw_bird_ld50)
        self.sa_bird_2_m = trex2_mod.sa_bird_2(self.a_i, self.den, self.m_s_r_p, self.at_bird,
                                          self.ld50_bird, self.aw_bird_md, self.tw_bird_ld50, self.x, 0.1)
        self.sc_bird_m = trex2_mod.sc_bird(self.a_i, self.den, self.NOAEC_bird)
        self.sa_mamm_1_m = trex2_mod.sa_mamm_1(self.a_i, self.den, self.at_mamm, self.fi_mamm, 0.1,
                                          self.ld50_mamm, self.aw_mamm_md, self.tw_mamm, 0.035)
        self.sa_mamm_2_m = trex2_mod.sa_mamm_2(self.a_i, self.den, self.m_s_r_p, self.at_mamm,
                                          self.ld50_mamm, self.aw_mamm_md, self.tw_mamm, 0.035)
        self.sc_mamm_m = trex2_mod.sc_mamm(self.a_i, self.den, self.NOAEL_mamm, self.aw_mamm_md,
                                      self.fi_mamm, 0.1, self.tw_mamm, self.ANOAEL_mamm, 0.035)

        self.sa_bird_1_l = trex2_mod.sa_bird_1(0.1, 1.0, self.aw_bird_lg, self.tw_bird_ld50)
        self.sa_bird_2_l = trex2_mod.sa_bird_2(self.a_i, self.den, self.m_s_r_p, self.at_bird,
                                          self.ld50_bird, self.aw_bird_lg, self.tw_bird_ld50, self.x, 1.0)
        self.sc_bird_l = trex2_mod.sc_bird(self.a_i, self.den, self.NOAEC_bird)
        self.sa_mamm_1_l = trex2_mod.sa_mamm_1(self.a_i, self.den, self.at_mamm, self.fi_mamm, 0.1,
                                          self.ld50_mamm, self.aw_mamm_lg, self.tw_mamm, 1)
        self.sa_mamm_2_l = trex2_mod.sa_mamm_2(self.a_i, self.den, self.m_s_r_p, self.at_mamm,
                                          self.ld50_mamm, self.aw_mamm_lg, self.tw_mamm, 1)
        self.sc_mamm_l = trex2_mod.sc_mamm(self.a_i, self.den, self.NOAEL_mamm, self.aw_mamm_lg,
                                      self.fi_mamm, 0.1, self.tw_mamm, self.ANOAEL_mamm, 1)

        # Table 6
        logging.info("table 6")
        self.EEC_diet_SG = trex2_mod.EEC_diet(self.C_t_sg, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                         self.day_out)
        self.EEC_diet_TG = trex2_mod.EEC_diet(self.C_t_tg, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                         self.day_out)
        self.EEC_diet_BP = trex2_mod.EEC_diet(self.C_t_blp, self.noa, self.first_app_lb, self.a_i, 135,
                                         self.h_l, self.day_out)
        self.EEC_diet_FR = trex2_mod.EEC_diet(self.C_t_f_p, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                         self.day_out)
        self.EEC_diet_AR = trex2_mod.EEC_diet(self.C_t_arhtro, self.noa, self.first_app_lb, self.a_i, 94,
                                         self.h_l, self.day_out)

        # Table 7
        logging.info("table 7")
        self.EEC_dose_bird_SG_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_SG_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_SG_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_TG_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_TG_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_TG_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_BP_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_BP_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_BP_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_FP_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_FP_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_FP_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_AR_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_AR_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_AR_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.9, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_SE_sm = trex2_mod.EEC_dose_bird(self.aw_bird_sm, self.fi_bird, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_SE_md = trex2_mod.EEC_dose_bird(self.aw_bird_md, self.fi_bird, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_bird_SE_lg = trex2_mod.EEC_dose_bird(self.aw_bird_lg, self.fi_bird, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)

        # Table 7_add
        self.ARQ_bird_SG_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_SG_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_SG_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_TG_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_TG_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_TG_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_BP_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_BP_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_BP_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_FP_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_FP_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_FP_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_AR_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_AR_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_AR_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.8, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_SE_sm = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_sm, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.1, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_SE_md = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_md, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.1, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        self.ARQ_bird_SE_lg = trex2_mod.ARQ_dose_bird(self.EEC_diet, self.aw_bird_lg, self.fi_bird,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x, 0.1, self.C_0,
                                                 self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                 self.day_out)
        ...
        self.ARQ_diet_bird_SG_A = trex2_mod.ARQ_diet_bird(self.lc50_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 240, self.h_l, self.day_out)
        self.ARQ_diet_bird_SG_C = trex2_mod.CRQ_diet_bird(self.NOAEC_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 240, self.h_l, self.day_out)
        self.ARQ_diet_bird_TG_A = trex2_mod.ARQ_diet_bird(self.lc50_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 110, self.h_l, self.day_out)
        self.ARQ_diet_bird_TG_C = trex2_mod.CRQ_diet_bird(self.NOAEC_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 110, self.h_l, self.day_out)
        self.ARQ_diet_bird_BP_A = trex2_mod.ARQ_diet_bird(self.lc50_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 135, self.h_l, self.day_out)
        self.ARQ_diet_bird_BP_C = trex2_mod.CRQ_diet_bird(self.NOAEC_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 135, self.h_l, self.day_out)
        self.ARQ_diet_bird_FP_A = trex2_mod.ARQ_diet_bird(self.lc50_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 15, self.h_l, self.day_out)
        self.ARQ_diet_bird_FP_C = trex2_mod.CRQ_diet_bird(self.NOAEC_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 15, self.h_l, self.day_out)
        self.ARQ_diet_bird_AR_A = trex2_mod.ARQ_diet_bird(self.lc50_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 94, self.h_l, self.day_out)
        self.ARQ_diet_bird_AR_C = trex2_mod.CRQ_diet_bird(self.NOAEC_bird, self.C_0, self.C_t, self.noa,
                                                     self.first_app_lb, self.a_i, 94, self.h_l, self.day_out)

        # Table 9
        logging.info("table 9")
        self.EEC_dose_mamm_SG_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_SG_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_SG_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_TG_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_TG_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_TG_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_BP_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_BP_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_BP_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_FP_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_FP_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_FP_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_AR_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_AR_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_AR_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_SE_sm = trex2_mod.EEC_dose_mamm(self.aw_mamm_sm, self.fi_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_SE_md = trex2_mod.EEC_dose_mamm(self.aw_mamm_md, self.fi_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.EEC_dose_mamm_SE_lg = trex2_mod.EEC_dose_mamm(self.aw_mamm_lg, self.fi_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)

        # Table 10
        logging.info("table 10")
        self.ARQ_dose_mamm_SG_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SG_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 240,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_SG_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SG_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 240,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_SG_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 240, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SG_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_lg, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 240,
                                                      self.h_l, self.day_out)

        self.ARQ_dose_mamm_TG_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_TG_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 110,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_TG_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_TG_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 110,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_TG_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 110, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_TG_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_lg, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 110,
                                                      self.h_l, self.day_out)

        self.ARQ_dose_mamm_BP_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_BP_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 135,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_BP_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_BP_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 135,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_BP_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 135, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_BP_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_lg, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 135,
                                                      self.h_l, self.day_out)

        self.ARQ_dose_mamm_FP_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_FP_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 15,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_FP_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_FP_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 15,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_FP_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_FP_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_lg, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 15,
                                                      self.h_l, self.day_out)

        self.ARQ_dose_mamm_AR_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_AR_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 94,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_AR_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_AR_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 94,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_AR_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.8, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 94, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_AR_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_lg, self.fi_mamm, self.tw_mamm, 0.8,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 94,
                                                      self.h_l, self.day_out)

        self.ARQ_dose_mamm_SE_sm = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_sm,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SE_sm = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_sm, self.fi_mamm, self.tw_mamm, 0.1,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 15,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_SE_md = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_md,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SE_md = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
                                                      self.NOAEL_mamm, self.aw_mamm_md, self.fi_mamm, self.tw_mamm, 0.1,
                                                      self.C_0, self.C_t, self.noa, self.first_app_lb, self.a_i, 15,
                                                      self.h_l, self.day_out)
        self.ARQ_dose_mamm_SE_lg = trex2_mod.ARQ_dose_mamm(self.EEC_diet, self.at_mamm, self.aw_mamm_lg,
                                                      self.fi_mamm, self.ld50_mamm, self.tw_mamm, 0.1, self.C_0,
                                                      self.C_t, self.noa, self.first_app_lb, self.a_i, 15, self.h_l,
                                                      self.day_out)
        self.CRQ_dose_mamm_SE_lg = trex2_mod.CRQ_dose_mamm(self.EEC_dose_mamm, self.ANOAEL_mamm,
        ...
        if self.lc50_mamm != 'N/A':
            self.ARQ_diet_mamm_SG = trex2_mod.ARQ_diet_mamm(self.lc50_mamm, self.C_0, self.C_t, self.noa,
                                                       self.first_app_lb, self.a_i, 240, self.h_l, self.day_out)
            self.ARQ_diet_mamm_TG = trex2_mod.ARQ_diet_mamm(self.lc50_mamm, self.C_0, self.C_t, self.noa,
                                                       self.first_app_lb, self.a_i, 110, self.h_l, self.day_out)
            self.ARQ_diet_mamm_BP = trex2_mod.ARQ_diet_mamm(self.lc50_mamm, self.C_0, self.C_t, self.noa,
                                                       self.first_app_lb, self.a_i, 135, self.h_l, self.day_out)
            self.ARQ_diet_mamm_FP = trex2_mod.ARQ_diet_mamm(self.lc50_mamm, self.C_0, self.C_t, self.noa,
                                                       self.first_app_lb, self.a_i, 15, self.h_l, self.day_out)
            self.ARQ_diet_mamm_AR = trex2_mod.ARQ_diet_mamm(self.lc50_mamm, self.C_0, self.C_t, self.noa,
                                                       self.first_app_lb, self.a_i, 94, self.h_l, self.day_out)
        else:
        ...
        self.CRQ_diet_mamm_SG = trex2_mod.CRQ_diet_mamm(self.NOAEC_mamm, self.C_0, self.C_t, self.noa,
                                                   self.first_app_lb, self.a_i, 240, self.h_l, self.day_out)
        self.CRQ_diet_mamm_TG = trex2_mod.CRQ_diet_mamm(self.NOAEC_mamm, self.C_0, self.C_t, self.noa,
                                                   self.first_app_lb, self.a_i, 110, self.h_l, self.day_out)
        self.CRQ_diet_mamm_BP = trex2_mod.CRQ_diet_mamm(self.NOAEC_mamm, self.C_0, self.C_t, self.noa,
                                                   self.first_app_lb, self.a_i, 135, self.h_l, self.day_out)
        self.CRQ_diet_mamm_FP = trex2_mod.CRQ_diet_mamm(self.NOAEC_mamm, self.C_0, self.C_t, self.noa,
                                                   self.first_app_lb, self.a_i, 15, self.h_l, self.day_out)
        self.CRQ_diet_mamm_AR = trex2_mod.CRQ_diet_mamm(self.NOAEC_mamm, self.C_0, self.C_t, self.noa,
                                                   self.first_app_lb, self.a_i, 94, self.h_l, self.day_out)

        # Table12
        logging.info("table 12")
        self.LD50_rg_bird_sm = trex2_mod.LD50_rg_bird(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_bird_sm, self.at_bird, self.ld50_bird,
                                                 self.tw_bird_ld50, self.x)
        self.LD50_rg_mamm_sm = trex2_mod.LD50_rg_mamm(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_mamm_sm, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_rg_bird_md = trex2_mod.LD50_rg_bird(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_bird_md, self.at_bird, self.ld50_bird,
                                                 self.tw_bird_ld50, self.x)
        self.LD50_rg_mamm_md = trex2_mod.LD50_rg_mamm(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_mamm_md, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_rg_bird_lg = trex2_mod.LD50_rg_bird(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_bird_lg, self.at_bird, self.ld50_bird,
                                                 self.tw_bird_ld50, self.x)
        self.LD50_rg_mamm_lg = trex2_mod.LD50_rg_mamm(self.first_app_lb, self.a_i, self.p_i, self.r_s,
                                                 self.b_w, self.aw_mamm_lg, self.at_mamm, self.ld50_mamm, self.tw_mamm)

        # Table13
        logging.info("table 13")
        self.LD50_rl_bird_sm = trex2_mod.LD50_rl_bird(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_bird_sm, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_rl_mamm_sm = trex2_mod.LD50_rl_mamm(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_mamm_sm, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_rl_bird_md = trex2_mod.LD50_rl_bird(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_bird_md, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_rl_mamm_md = trex2_mod.LD50_rl_mamm(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_mamm_md, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_rl_bird_lg = trex2_mod.LD50_rl_bird(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_bird_lg, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_rl_mamm_lg = trex2_mod.LD50_rl_mamm(self.first_app_lb, self.a_i, self.p_i, self.b_w,
                                                 self.aw_mamm_lg, self.at_mamm, self.ld50_mamm, self.tw_mamm)

        # Table14
        logging.info("table 14")
        self.LD50_bg_bird_sm = trex2_mod.LD50_bg_bird(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_bird_sm, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_bg_mamm_sm = trex2_mod.LD50_bg_mamm(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_mamm_sm, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_bg_bird_md = trex2_mod.LD50_bg_bird(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_bird_md, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_bg_mamm_md = trex2_mod.LD50_bg_mamm(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_mamm_md, self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_bg_bird_lg = trex2_mod.LD50_bg_bird(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_bird_lg, self.at_bird, self.ld50_bird, self.tw_bird_ld50,
                                                 self.x)
        self.LD50_bg_mamm_lg = trex2_mod.LD50_bg_mamm(self.first_app_lb, self.a_i, self.p_i,
                                                 self.aw_mamm_lg, self.at_mamm, self.ld50_mamm, self.tw_mamm)

        # Table15
        logging.info("table 15")
        self.LD50_bl_bird_sm = trex2_mod.LD50_bl_bird(self.first_app_lb, self.a_i, self.aw_bird_sm,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x)
        self.LD50_bl_mamm_sm = trex2_mod.LD50_bl_mamm(self.first_app_lb, self.a_i, self.aw_mamm_sm,
                                                 self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_bl_bird_md = trex2_mod.LD50_bl_bird(self.first_app_lb, self.a_i, self.aw_bird_md,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x)
        self.LD50_bl_mamm_md = trex2_mod.LD50_bl_mamm(self.first_app_lb, self.a_i, self.aw_mamm_md,
                                                 self.at_mamm, self.ld50_mamm, self.tw_mamm)
        self.LD50_bl_bird_lg = trex2_mod.LD50_bl_bird(self.first_app_lb, self.a_i, self.aw_bird_lg,
                                                 self.at_bird, self.ld50_bird, self.tw_bird_ld50, self.x)
        self.LD50_bl_mamm_lg = trex2_mod.LD50_bl_mamm(self.first_app_lb, self.a_i, self.aw_mamm_lg,
                                                 self.at_mamm, self.ld50_mamm, self.tw_mamm)
